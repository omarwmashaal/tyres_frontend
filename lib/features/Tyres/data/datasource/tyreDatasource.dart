...
abstract class TyreDatasource {
  ...
  Future<NoParams> installTyreToATruck(int tyreId, int truckId);
...
class TyreDatasourceImpl implements TyreDatasource {
  ...
  @override
  Future<NoParams> installTyreToATruck(int tyreId, int truckId) async {
    // Mock implementation for installing a tyre to a truck
    return Future.value(NoParams());
  }

  @override
  Future<NoParams> removeTyreFromATruck(int tyreId, int truckId) async {
    // Mock implementation for removing a tyre from a truck
    return Future.value(NoParams());
  }
}
